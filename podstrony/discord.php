<div class="swiper-slide">
        <table>
                    <td>
                    <img src="img/dzik3.jpg" class="photo">
                    </td>
                    <td>
                <section class="text">
...
<ul class="text_left">
    ...
    <li>Rozwijajaca się społeczność;</li>
    <li>Mozliwosc uczestniczenia w różnych streamach;</li>
    <li>Ładny wystrój serwera;</li>
    <li>Wiele kanałów tekstowych jak i głosowych;</li>
    <li>Mnóstwo ciekawych rang</li>
</ul>
</p>    
